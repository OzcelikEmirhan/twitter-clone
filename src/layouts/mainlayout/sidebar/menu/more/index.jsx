...
export default function More(){
    ...
    return(
        ...
        <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
                ...
                <button className="px-4 h-14 w-full rounded-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                        <svg viewBox="0 0 24 24" width={26.25} height={26.25} aria-hidden="true" fill="#fff"><g><path fill="#fff" xmlns="http://www.w3.org/2000/svg" d="M17.4009 19.2C15.8965 20.3302 14.0265 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12V13.5C21 14.8807 19.8807 16 18.5 16C17.1193 16 16 14.8807 16 13.5V8M16 12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g></svg>
                    <div className="pr-4 text-xl font-bold">
                        Bağlan
                    </div>
                </button>
                <button className="px-4 h-14 w-full rounded-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                    <svg viewBox="0 0 24 24" width={26.25} height={26.25} aria-hidden="true" ><g><path fill="#e7e9ea" d="M23 3v14h-2V5H5V3h18zM10 17c1.1 0 2-1.34 2-3s-.9-3-2-3-2 1.34-2 3 .9 3 2 3zM1 7h18v14H1V7zm16 10c-1.1 0-2 .9-2 2h2v-2zm-2-8c0 1.1.9 2 2 2V9h-2zM3 11c1.1 0 2-.9 2-2H3v2zm0 4c2.21 0 4 1.79 4 4h6c0-2.21 1.79-4 4-4v-2c-2.21 0-4-1.79-4-4H7c0 2.21-1.79 4-4 4v2zm0 4h2c0-1.1-.9-2-2-2v2z"></path></g></svg>
                    <div className="pr-4 text-xl font-bold">
                        Para kazanma
                    </div>
                </button>
                ...
                <Disclosure>
                        <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold hover:bg-[#eff3f41a] transition-colors">
                            ...
                            <svg viewBox="0 0 24 24" aria-hidden="true" width={18.75} height={18.75} ><g><path fill="#fff" d="M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z"></path></g></svg>
                        </Disclosure.Button>
                    <Disclosure.Panel className="text-gray-500">
                     ...
                     <svg viewBox="0 0 24 24" aria-hidden="true" width={18.75} height={18.75} ><g><path fill="#fff" d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"></path></g></svg>  
                      İstatistikler 
                     </Link>                 
                    </Disclosure.Panel>
                </Disclosure>
                <Disclosure>
                    ...
                    <Disclosure.Panel >
                    <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#eff3f41a] transition-colors text-white">
                     <svg viewBox="0 0 24 24" aria-hidden="true" width={18.75} height={18.75} ><g><path fill="#fff" d="M1.996 5.5c0-1.38 1.119-2.5 2.5-2.5h15c1.38 0 2.5 1.12 2.5 2.5v13c0 1.38-1.12 2.5-2.5 2.5h-15c-1.381 0-2.5-1.12-2.5-2.5v-13zm2.5-.5c-.277 0-.5.22-.5.5v13c0 .28.223.5.5.5h15c.276 0 .5-.22.5-.5v-13c0-.28-.224-.5-.5-.5h-15zm8.085 5H8.996V8h7v7h-2v-3.59l-5.293 5.3-1.415-1.42L12.581 10z"></path></g></svg>  
                      Reklamlar 
                     </Link>                     
                    </Disclosure.Panel>
                </Disclosure>
